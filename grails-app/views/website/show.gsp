...
<html>
    ...
    <body>
        ...
        <div id="show-website" class="content scaffold-show" role="main">
            ...
            <f:display bean="website" />
            <g:form resource="${this.website}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.website}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
