...
<html>
    ...
    <body>
        ...
        <div id="show-conversation" class="content scaffold-show" role="main">
            ...
            <f:display bean="conversation" />
            <g:form resource="${this.conversation}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.conversation}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
